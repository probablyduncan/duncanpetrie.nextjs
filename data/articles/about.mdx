...
I built this iteration ([github](https://github.com)) in the early months of 2023 using Next.JS and MDX. You can explore previous iterations of my website [here](/a/sites).
