...
title: 'Halfisle'
color: '#9e996b'
coords: [0.50,0.74, 1600]
groups: 'regions,#cauldron,#daybreak,#ingle,the east'
intro: '[Halfisle] is a mostly wild peninsula of cedar bogs and sandy open fens and square, white, green-capped bluffs, each a suggestion of a bay just beyond. It rises north from Daybreak and separates the Cauldron from the wide open sea.'
---
...
> The open shore of Halfisle is wild save Hither, brambled and empty compared to the west. The forest road to Hither is scrappy and narrow. The town itself, too, has a scrappy character, and they scoff, mostly playfully, at the calm and the ease of the Cauldronside.