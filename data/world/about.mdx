...
groups: 'meta'
intro: "[About] - The world of Springtide is many years in the making. It began with maps, and names on maps, and over time I began to figure out what those names meant. This wiki-thing is and will probably always be a work in progress, but it's a start."
---
...
To start, see an [overview](yon) of the world, or pick from some of my [favorite entries](/w?filter=best).
