...
export function getColors( frontmatterColors, imageKeys ) {
    ...
    return frontmatterColors ? [frontmatterColors[0], frontmatterColors[1] ?? frontmatterColors[0]] : [imgData[imageKeys[0]]?.color ?? '#6495ed', imgData[imageKeys[1]]?.color ?? '#6495ed'];
